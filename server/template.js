/**
 * Builds the personalized OTCMS SMS for a given recipient row.
 * Template fields are configurable so the team can reuse this for
 * future campaigns without touching code.
 */
